...
import org.seminify.spring5fs.config.AppCtxNoMemberPrinterBean;
...
public class MainForNoMemberPrinterBean {
    ...
    public static void main(String[] args) throws IOException {
        applicationContext = new AnnotationConfigApplicationContext(AppCtxNoMemberPrinterBean.class);
